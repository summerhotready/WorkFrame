...
import com.guoxd.workframe.widge.materialcalendar.Util.CalendarUtils;
...
public class MonthView extends ViewGroup {
    ...
    public MonthView(Context context, CalendarDay calendarDay, boolean startsOnSunday, @NonNull CalendarCallback callback, OnDateChangedListener listener, int pagerPosition) {
        this(context,calendarDay,startsOnSunday,callback,listener,pagerPosition,android.R.color.black,android.R.color.white,android.R.color.darker_gray);
    }

    public MonthView(Context context, CalendarDay calendarDay, boolean startsOnSunday, @NonNull CalendarCallback callback, OnDateChangedListener listener, int pagerPosition, int calendarTextColor, int selectTextColor, int selectBGColor) {
        super(context);
...
//            textView.setTypeface(null, Typeface.BOLD);
            textView.setTextColor(calendarTextColor);
//            textView.setTextColor(ContextCompat.getColor(this.getContext(), android.R.color.black));
    ...
    private void addDayView(CalendarDay day) {
        DayView dayView = new DayView(getContext(), day,calendarTextColor,selectTextColor,selectBGColor);
