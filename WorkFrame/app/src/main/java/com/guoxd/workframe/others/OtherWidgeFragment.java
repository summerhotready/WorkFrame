...
public class OtherWidgeFragment extends BaseFragment2 implements View.OnClickListener {
    ...
    private void initTab2(View root){
        ...
        int width = getResources().getDisplayMetrics().widthPixels/3- UIUtil.dip2px(mActivity, 16.0);
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, int index) {
                //设置单个tab的样式
                ColorTransitionPagerTitleView simplePagerTitleView = new ColorTransitionPagerTitleView(mActivity);
...
//                        LogUtil.e(TAG,position);
            ...
            public IPagerIndicator getIndicator(Context context) {
                LinePagerIndicator linePagerIndicator = new LinePagerIndicator(mActivity);
                //设置指示器颜色
...
//        pop1 = popView;
        ...
        mPop1 = new PopupWindow(view, ViewHelpUtils.dipTopx(mActivity,150), ViewGroup.LayoutParams.WRAP_CONTENT);
...
//                                        ToastUtils.ToastMessage(getContext(), "tx1");
            ...
            case R.id.pop_3://可以在View下显示
                new TestBasePop(mActivity).showPopupWindow(pop3);
                break;
            case R.id.pop_4:
