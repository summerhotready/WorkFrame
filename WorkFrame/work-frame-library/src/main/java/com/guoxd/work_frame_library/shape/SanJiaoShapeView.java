 ...
 * 画一个三角形
 */
public class SanJiaoShapeView extends View {
    ...
    public SanJiaoShapeView(Context context) {
        super(context);
    }

    public SanJiaoShapeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
