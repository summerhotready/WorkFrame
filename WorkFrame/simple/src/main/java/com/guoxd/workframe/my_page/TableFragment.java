...
import com.guoxd.work_frame_library.views.hscroll.HScrollView;
import com.guoxd.work_frame_library.views.hscroll.OnScrollChangedListener;
import com.guoxd.work_frame_library.views.hscroll.SaleData;
 ...
 */
public class TableFragment extends BaseFragment implements OnScrollChangedListener {
...
//    private TablePopDialog popTable;
    ...
    protected int getCurrentLayoutID() {
        return R.layout.my_fragment_table;
    }
...
//        });
    ...
    protected void initView(View root) {
        mContain = (LinearLayout)root.findViewById(R.id.contain);
