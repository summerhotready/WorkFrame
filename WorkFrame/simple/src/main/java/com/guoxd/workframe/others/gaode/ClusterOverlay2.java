 ...
 * 高德原来的代码
 */
public class ClusterOverlay2 implements AMap.OnCameraChangeListener,
     ...
     * @param context
     */
    public ClusterOverlay2(AMap amap, int clusterSize, Context context) {
     ...
     * @param context
     */
    public ClusterOverlay2(AMap amap, List<ClusterItem> clusterItems,
    ...
    private void addSingleClusterToMap(Cluster cluster) {
        ...
        markerOptions.anchor(0.5f, 0.5f)
                .position(latlng);
        setMarkerDrable(markerOptions,cluster.getClusterCount());//icon(getBitmapDes(cluster.getClusterCount()))
...
//重新计算聚合点
    ...
    private void setMarkerDrable(MarkerOptions markerOption,int num){
        if(num>1){
            markerOption.icon(getBitmapDes(num));
            ;
        }else{
            ArrayList<BitmapDescriptor> iconList = new ArrayList<>();
//            iconList.add(BitmapDescriptorFactory.fromResource(R.mipmap.device_alert_00000));
//            iconList.add(BitmapDescriptorFactory.fromResource(R.mipmap.device_alert_00001));
//            iconList.add(BitmapDescriptorFactory.fromResource(R.mipmap.device_alert_00002));
//            iconList.add(BitmapDescriptorFactory.fromResource(R.mipmap.device_alert_00003));
//            iconList.add(BitmapDescriptorFactory.fromResource(R.mipmap.device_alert_00004));
//            iconList.add(BitmapDescriptorFactory.fromResource(R.mipmap.device_alert_00005));
//            iconList.add(BitmapDescriptorFactory.fromResource(R.mipmap.device_alert_00006));
//            iconList.add(BitmapDescriptorFactory.fromResource(R.mipmap.device_alert_00007));
            markerOption.icons(iconList).period(10);
        }
    }
