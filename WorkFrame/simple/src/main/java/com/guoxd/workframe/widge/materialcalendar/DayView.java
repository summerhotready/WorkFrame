...
public class DayView extends FrameLayout {
    ...
    public DayView(Context context, CalendarDay day) {
        this(context,day,android.R.color.black,android.R.color.white,android.R.color.darker_gray);
    }
    public DayView(Context context, CalendarDay day, int calendarTextColor, int selectTextColor, int selectBGColor) {
        super(context);
    ...
    private void init() {
        ...
        this.tvDay.setTextColor(calendarTextColor);
//        this.tvDay.setTextColor(ContextCompat.getColor(getContext(), android.R.color.black));
    ...
    public void setSelected(boolean selected) {
        if (this.selected != selected) {
            ...
            if (this.selected) {
                ...
                this.tvDay.setTextColor(selectTextColor);
//                this.tvDay.setTextColor(ContextCompat.getColor(getContext(), R.color.colorAccent));
            ...
            this.tvDay.setTextColor(calendarTextColor);
//            this.tvDay.setTextColor(ContextCompat.getColor(getContext(), android.R.color.white));
    ...
    private Drawable getSelectionDrawable() {
        if (_selectionDrawable == null) {
            _selectionDrawable = generateCircleDrawable(selectBGColor);
//            _selectionDrawable = generateCircleDrawable(ContextCompat.getColor(getContext(), android.R.color.white));
        }
    ...
    private Drawable getIndicatorDrawable() {
        if (_indicatorDrawable == null) {
            _indicatorDrawable = generateCircleDrawable(selectTextColor);
